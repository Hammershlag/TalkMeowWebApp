...
public class AdminTests {
    ...
    public void testUserInappropriateMessagesPage() throws Exception {
        ...
        User user = users.get(0).getUsername().equals(adminUsername) ? users.get(1) : users.get(0);

        this.mockMvc.perform(get("/admin/user/" + user.getId() + "/messages").session(session))
                .andExpect(status().isOk())
    ...
    public void testAccessUserBans() throws Exception {
        ...
        this.mockMvc.perform(get("/admin/user/" + user.getId() + "/bans").session(session))
                .andExpect(status().isOk())
    ...
    public void testBanUser() throws Exception {
        ...
        this.mockMvc.perform(get("/admin/user/" + user.getId() + "/ban")
